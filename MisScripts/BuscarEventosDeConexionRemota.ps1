<#
.SYNOPSIS
    Este script busca eventos RDP con una interfaz gráfica.

.DESCRIPTION
    Este script utiliza PowerShell y Windows Forms para crear una interfaz gráfica que permite buscar eventos relacionados a las conexiones RDP. 
...
.EXAMPLE
    Ejecuta el script para abrir la interfaz gráfica y buscar eventos de conexion remota (RDP).

.NOTES
    Requiere ejecutarse con permisos de administrador para poder acceder a los eventos.
#>
Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.Drawing

$RutaArchivo = "Eventos.csv"
$NombreLog = "Microsoft-Windows-TerminalServices-LocalSessionManager/Operational"
...
Function Buscar {
    ...
    Try {
        if ($CajaID.Text -ne "" -and $CajaDias.Text -ne "") {
            $FechaLimite = (Get-Date).AddDays(-([int]$CajaDias.Text)).ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss")
            $Eventos = Get-WinEvent -LogName $NombreLog -FilterXPath "*[System[EventID=$($CajaID.Text) and TimeCreated[@SystemTime >= '$($FechaLimite)']]]" -ErrorAction Stop
        }
        elseif ($CajaID.Text -ne "") {
            $Eventos = Get-WinEvent -LogName $NombreLog -FilterXPath "*[System[EventID=$($CajaID.Text)]]" -ErrorAction Stop
        }
        elseif ($CajaDias.Text -ne "") {
            $FechaLimite = (Get-Date).AddDays(-([int]$CajaDias.Text)).ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss")
            $Eventos = Get-WinEvent -LogName $NombreLog -FilterXPath "*[System[TimeCreated[@SystemTime >= '$($FechaLimite)']]]" -ErrorAction Stop
        }
        else {
            $Eventos = Get-WinEvent -LogName $NombreLog -FilterXPath "*" -ErrorAction Stop
        }

        if ($Eventos.Count -eq 0) {
            [System.Windows.Forms.MessageBox]::Show("No se encontraron eventos con los criterios especificados.", "Sin resultados", "OK", "Information")
            return
        }

        foreach ($evento in $Eventos) {
            $DataGridView.Rows.Add($evento.ID, $evento.TimeCreated, $evento.Message)
        }
    }
    Catch {
        [System.Windows.Forms.MessageBox]::Show("Error al buscar eventos: " + $_.Exception.Message, "Error", "OK", "Error")
    }
}

# Función para exportar eventos a un CSV en formato tabular
function ExportarArchivo {
    if ($DataGridView.Rows.Count -eq 0) {
        [System.Windows.Forms.MessageBox]::Show("No hay eventos para exportar.", "Sin datos", "OK", "Warning")
        return
    }
    ...
    Try {
        ...
        foreach ($fila in $DataGridView.Rows) {
            ...
            $fecha = $fila.Cells[1].Value
            $mensaje = $fila.Cells[2].Value

            # Reemplazar saltos de línea en el mensaje con un espacio o separador personalizado
            $mensaje = $mensaje -replace "`n", " "  # Reemplaza saltos de línea con un espacio
            $mensaje = $mensaje -replace "`r", ""   # Elimina retornos de carro (si existen)
        ...
        # Exportar a CSV
        $datos | Export-Csv -Path $RutaArchivo -NoTypeInformation -Encoding UTF8 -ErrorAction Stop

        [System.Windows.Forms.MessageBox]::Show("Archivo exportado exitosamente a: $RutaArchivo", "Exportación Completada", "OK", "Information")
    }
    Catch {
        [System.Windows.Forms.MessageBox]::Show("Error al exportar el archivo: " + $_.Exception.Message, "Error", "OK", "Error")
    }
}

# Inicio de ventana
$Ventana = New-Object System.Windows.Forms.Form
$Ventana.Text = "Buscar y Filtrar Eventos de Conexion Remota"
$Ventana.StartPosition = "CenterScreen"
$Ventana.Width = 1000
$Ventana.Height = 600
$Ventana.BackColor = $colorSecundario
$Ventana.Font = $fuenteModerna
    ...
    $Ventana.Controls.Add($pictureBox)

# Panel superior para controles
$panelControl = New-Object System.Windows.Forms.Panel
$panelControl.Dock = [System.Windows.Forms.DockStyle]::Top
$panelControl.Height = 80
$panelControl.BackColor = $colorSecundario
$panelControl.Padding = New-Object System.Windows.Forms.Padding(10)

# Título
$labelTitulo = New-Object System.Windows.Forms.Label
$labelTitulo.Text = "Busqueda de Eventos"
$labelTitulo.Font = $fuenteTitulo
$labelTitulo.ForeColor = $colorTexto
$labelTitulo.Location = New-Object System.Drawing.Point(20, 10)
$labelTitulo.AutoSize = $true
$panelControl.Controls.Add($labelTitulo)

# Panel para filtros
$panelFiltros = New-Object System.Windows.Forms.Panel
$panelFiltros.Location = New-Object System.Drawing.Point(20, 40)
$panelFiltros.Size = New-Object System.Drawing.Size(950, 35)
$panelControl.Controls.Add($panelFiltros)

# Etiqueta para buscar Event-ID
$EtiquetaID = New-Object System.Windows.Forms.Label
$EtiquetaID.Text = "Event-ID:"
$EtiquetaID.Location = New-Object System.Drawing.Point(0, 8)
$EtiquetaID.AutoSize = $true
Set-LabelStyle $EtiquetaID
$panelFiltros.Controls.Add($EtiquetaID)

# Caja para Event-ID
$CajaID = New-Object System.Windows.Forms.TextBox
$CajaID.Location = New-Object System.Drawing.Point(60, 5)
$CajaID.Width = 80
Set-TextBoxStyle $CajaID
$panelFiltros.Controls.Add($CajaID)

# Etiqueta para días
$EtiquetaDias = New-Object System.Windows.Forms.Label
$EtiquetaDias.Text = "Dias de antiguedad:"
$EtiquetaDias.Location = New-Object System.Drawing.Point(160, 8)
$EtiquetaDias.AutoSize = $true
Set-LabelStyle $EtiquetaDias
$panelFiltros.Controls.Add($EtiquetaDias)

# Caja para días
$CajaDias = New-Object System.Windows.Forms.TextBox
$CajaDias.Location = New-Object System.Drawing.Point(275, 5)
$CajaDias.Width = 80
Set-TextBoxStyle $CajaDias
$panelFiltros.Controls.Add($CajaDias)

# Botón Buscar
$Buscar = New-Object System.Windows.Forms.Button
$Buscar.Text = "Buscar"
$Buscar.Location = New-Object System.Drawing.Point(370, 3)
$Buscar.Width = 120
$Buscar.Height = 30
Set-ButtonStyle $Buscar
$Buscar.Add_Click({ Buscar })
$panelFiltros.Controls.Add($Buscar)

# Botón Exportar
$Exportar = New-Object System.Windows.Forms.Button
$Exportar.Text = "Exportar"
$Exportar.Location = New-Object System.Drawing.Point(500, 3)
$Exportar.Width = 120
$Exportar.Height = 30
Set-ButtonStyle $Exportar
$Exportar.Add_Click({ ExportarArchivo })
$panelFiltros.Controls.Add($Exportar)

# DataGridView para mostrar los eventos
$DataGridView = New-Object System.Windows.Forms.DataGridView
$DataGridView.Dock = [System.Windows.Forms.DockStyle]::Fill
$DataGridView.BackgroundColor = $colorFondo
$DataGridView.Font = $fuenteModerna
$DataGridView.ForeColor = $colorTexto
$DataGridView.ColumnHeadersDefaultCellStyle.BackColor = $colorPrimario
$DataGridView.ColumnHeadersDefaultCellStyle.ForeColor = [System.Drawing.Color]::White
$DataGridView.ColumnHeadersDefaultCellStyle.Font = $fuenteModerna
...
$DataGridView.Columns.Add("Mensaje", "Mensaje")
# Ajustar propiedades de las columnas
$DataGridView.Columns[0].Width = 30
$DataGridView.Columns[1].Width = 100
$DataGridView.Columns[2].Width = 810

# Panel contenedor para DataGridView con padding
$panelLista = New-Object System.Windows.Forms.Panel
$panelLista.Dock = [System.Windows.Forms.DockStyle]::Fill
$panelLista.Padding = New-Object System.Windows.Forms.Padding(20)
$panelLista.BackColor = $colorFondo
$panelLista.Controls.Add($DataGridView)

# Agregar paneles al formulario
$Ventana.Controls.Add($panelLista)
$Ventana.Controls.Add($panelControl)
